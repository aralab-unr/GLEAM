...
def generate_launch_description():
    ...
    imu_topic = LaunchConfiguration('imu_topic', default='/handsfree/imu')
    img_topic = LaunchConfiguration('img_topic', default='/alphasense_driver_ros/cam0/debayered/image_raw')
    ...
    # Load parameters
    rls_yaml_path = PathJoinSubstitution([current_pkg, 'cfg', 'm2dgr.yaml'])
